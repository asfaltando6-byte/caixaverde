...
const bonusItems=[
 ...
 {title:"Como Vender Mais no Seu Hortifruti",description:"Ideias práticas para melhorar a exposição, aumentar o giro e aproveitar melhor cada oportunidade de venda no hortifruti.",image:"/assets/carousel-estoque.png"},
 {title:"Exemplos de Cross-sell para Aumentar o Ticket das Suas Vendas",description:"Combinações simples de produtos para oferecer compras complementares e aumentar o valor médio de cada venda.",image:"/assets/carousel-preco.png"},
];
...
export default function Home(){return <main>
 ...
 <section className="section useSection" aria-labelledby="como-usar-titulo"><div className="shell"><div className="narrow center useHead"><span className="tag">COMO USAR O CAIXAVERDE</span><h2 id="como-usar-titulo">Do diagnóstico à ação em <em>poucos minutos por dia</em></h2><p className="lead">Você não precisa mudar toda a rotina da loja de uma vez. Siga estes 4 passos simples:</p></div><div className="useGrid">{[["01","Baixe e abra","Acesse o PDF pelo celular, computador ou imprima as folhas que vai usar."],["02","Faça o diagnóstico","Responda às perguntas para identificar quais ralos merecem atenção primeiro."],["03","Aplique por 15 minutos","Escolha uma ação do plano e coloque em prática na rotina do mercadinho."],["04","Acompanhe a evolução","Use os checklists para registrar o que foi corrigido e definir o próximo passo."]].map(x=><article key={x[0]}><b>{x[0]}</b><div><h3>{x[1]}</h3><p>{x[2]}</p></div></article>)}</div><div className="useNote"><Check/><span><strong>Comece pelo maior ralo.</strong> Uma melhoria por dia já deixa o processo simples e possível de manter.</span></div></div></section>
